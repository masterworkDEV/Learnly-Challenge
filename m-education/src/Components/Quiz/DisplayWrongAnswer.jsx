...
const DisplayWrongAnswer = () => {
  const { newQuiz, currentQuestion } = useContext(DataContext);
  return (
    <>
      <div className="show-wrong-answer">
        <svg
          fill="none"
          height="200px"
          width="200px"
        ...
        <p>
          You failed<b> {newQuiz[currentQuestion].correct_answer} </b>
...
export default DisplayWrongAnswer;
